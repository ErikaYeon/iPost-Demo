...
import { SafeAreaView, TouchableOpacity, View, Image, Text, ActivityIndicator } from 'react-native';
...
const WelcomeScreen: React.FC = () => {
  ...
  return (
    <SafeAreaView style={sharedStyles.screenContainer}>
      <Image source={require('../assets/images/icons/LogoiPost.png')} style={{ width: 180, height: 180 }} />
      ...
      >
        <Image source={require('../assets/images/icons/Google.png')} style={{ width: 24, height: 24 }} />
